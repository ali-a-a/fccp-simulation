...
sshpass -p "/root/destination/pass" scp /root/fccp-simulation/goweb/dockerc.tar  root@'$DEST_IP':/root/fccp-simulation/goweb/dockerc.tar

# Notify the destination
curl -X "POST" '$DEST_IP'/load
